...
object ScalaTestRunConfiguration {
  case class Module(override val module: ModuleRef)
    extends ScalaTestRunConfiguration(module)
  case class Package(override val module: ModuleRef, packageName: String)
    extends ScalaTestRunConfiguration(module)
  case class Class(override val module: ModuleRef, className: String)
    extends ScalaTestRunConfiguration(module)
