...
object Dependencies {
  ...
  val remoteRobot = "com.intellij.remoterobot" % "remote-robot" % "0.11.17"

  val remoteRobotFixtures = "com.intellij.remoterobot" % "remote-fixtures" % "0.11.17"
  ...
  val pureConfig: Seq[ModuleID] = {
    ...
    pureConfigModules.map { module =>
      "com.github.pureconfig" %% module % "0.17.2"
