...
import com.virtuslab.idea.RunnerSettingsWithProcessOutput
...
import com.virtuslab.ideprobe.protocol.TestRun
import com.virtuslab.ideprobe.protocol.TestStatus
import com.virtuslab.ideprobe.protocol.TestSuite
...
object RunConfigurations extends IntelliJApi {
  ...
  private def registerObservableConfiguration(mainClass: ApplicationRunConfiguration): RunnerSettingsWithProcessOutput = {
