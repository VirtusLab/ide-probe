...
```scala
libraryDependencies += "org.virtuslab.ideprobe" %% "driver" % "0.16.0"
```
...
dependencies {
    implementation group: 'org.virtuslab.ideprobe', name: 'driver_2.13', version: '0.16.0'
}
```
...
// example
libraryDependencies += "org.virtuslab.ideprobe" %% "scala-probe-driver" % "0.16.0"
```
